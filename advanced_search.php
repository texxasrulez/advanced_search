...
class advanced_search extends rcube_plugin
{
    ...
    public function preferences_list($args)
    {
        if ('advancedsearch' == $args['section']) {
            ...
            $img1 = html::img(['src' => $this->url('skins/' . $this->skin . '/images/show_mbox_row.jpg'), 'class' => $img1class]);
            $img2 = html::img(['src' => $this->url('skins/' . $this->skin . '/images/show_mbox_col.jpg'), 'class' => $img2class]);
            $img3 = html::img(['src' => $this->url('skins/' . $this->skin . '/images/' . $target_image)]);
